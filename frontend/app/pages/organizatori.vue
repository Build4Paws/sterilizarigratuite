...
const faqItems = [
  ...
  },
  {
    ...
    a: 'Imediat ce campania ta este aprobată, trimitem automat SMS sau email tuturor cetățenilor înregistrați din localitatea unde are loc. Tu nu trebuie să faci nimic.',
  },
  {
